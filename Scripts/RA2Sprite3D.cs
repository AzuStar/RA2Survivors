...
namespace RA2Survivors
{
	...
	{
		public Dictionary<string, RA2SpriteAnim> AnimDefinitions = new Dictionary<string, RA2SpriteAnim>();
		...
		public override void _Process(double delta)
		{
			if (CurrentAnim != null) {
				...
				Frame = (int)Math.Floor(Double.Lerp(CurrentAnimDef.StartFrame, CurrentAnimDef.EndFrame, CurrentFrameTime / FrameTime));
				GD.Print(Frame);
			}
		}
	}
